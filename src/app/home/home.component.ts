...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [CommonModule, MatSlideToggleModule, ProfileComponent, MapsComponent, TechsComponent, DarkmodeComponent, SocialComponent, ContactMeComponent, HowItStartedComponent, GithubComponent],
